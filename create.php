...
<body>
    ...
    <form action="create.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="lastName" name="lastName" value="<?php echo htmlspecialchars($personData['lastName']); ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" id="medicareID" name="medicareID" value="<?php echo htmlspecialchars($personData['medicareID']); ?>">
        </div>

        <div class="form-group">
            <label for="address">Address:</label>
            <input type="text" id="address" name="address" value="<?php echo htmlspecialchars($personData['address']); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="province" name="province" value="<?php echo htmlspecialchars($personData['province']); ?>">
        </div>

        <div class="form-group">
            <label for="postalCode">Postal Code:</label>
            <input type="text" id="postalCode" name="postalCode" value="<?php echo htmlspecialchars($personData['postalCode']); ?>">
        </div>

        <div class="form-group">
            <label for="dateOfBirth">Date of Birth:</label>
            <input type="date" id="dateOfBirth" name="dateOfBirth" value="<?php echo htmlspecialchars($personData['dateOfBirth']); ?>">
