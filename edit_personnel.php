    ...
    <form action="edit_personnel.php?id=<?php echo htmlspecialchars($personnelData['personnelID']); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <select id="role" name="role">
                <option value="Administrator" <?php echo $personnelData['role'] === 'Administrator' ? 'selected' : ''; ?>>Administrator</option>
                <option value="Trainer" <?php echo $personnelData['role'] === 'Trainer' ? 'selected' : ''; ?>>Trainer</option>
        ...
        <div class="form-group">
            ...
            <select id="mandate" name="mandate">
                <option value="Volunteer" <?php echo $personnelData['mandate'] === 'Volunteer' ? 'selected' : ''; ?>>Volunteer</option>
                <option value="Salary" <?php echo $personnelData['mandate'] === 'Salary' ? 'selected' : ''; ?>>Salary</option>
            </select>
            <span class="error"><?php echo isset($errors['mandate']) ? htmlspecialchars($errors['mandate']) : ''; ?></span>
        </div>

        <div class="form-group">
            <label for="activationDate">Activation Date:</label>
            <input type="date" id="activationDate" name="activationDate" value="<?php echo htmlspecialchars($personnelData['activationDate']); ?>">
